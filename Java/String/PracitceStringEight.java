//새로 배운 것
//toCharArray:이 인스턴스의 문자를 유니코드 문자 배열에 복사합니다.
//(문자열의 문자를 문자 배열로 추출)
...
public class PracitceStringEight{
	int time;
	public Scanner sc;
...
전화를 걸고 싶은 번호가 있다면,
 ...
 숫자를 하나 누르면 다이얼이 처음 위치로 돌아가고, 다음 숫자를 누르려면 다이얼을 처음 위치에서 
 다시 돌려야 한다.
...
입력
첫째 줄에 알파벳 대문자로 이루어진 단어가 주어진다. 단어의 길이는 2보다 크거나 같고, 
15보다 작거나 같다.
